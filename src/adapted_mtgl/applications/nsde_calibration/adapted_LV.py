...
if __name__ == '__main__':
    ...
    lv_model = Net_LV(dim=1, timegrid=timegrid, strikes_call=strikes_call, n_layers=args.n_layers,
    ...
    print('Saving stock price trajectory to file data/stock_traj_LV.txt and diffusion params to file data/LV_diffusion.txt.')
    np.savetxt('data/stock_traj_LV.txt', path.numpy())
    np.savetxt('data/LV_diffusion.txt',diffusion.numpy())
